...
async function run() {
  try {
    ...
    const classCardsCollection = client.db("academyDB").collection("classCards");
    const paymentsCollection = client.db("academyDB").collection("payments");
    ...
    // send JWT token when user loggIn
